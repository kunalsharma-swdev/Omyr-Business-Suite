    ...
    <div className="bg-[#FFF8FC] dark:bg-[#09061A]">
      ...
      <div className="relative pt-28 pb-20 overflow-hidden bg-gradient-to-br from-white via-[#FFF8FC] to-[#FDF4FF] dark:from-[#09061A] dark:via-[#0F0C1E] dark:to-[#0D0920]">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10 text-center">
          <p className="text-[#E8177A] font-sans text-[11px] tracking-[0.4em] uppercase mb-5 font-medium">Our Story</p>
          <h1 className="text-5xl md:text-6xl font-serif font-light text-[#1F2937] dark:text-[#F1F0F5] mb-6 leading-tight">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl -mt-8 relative z-20 pb-16">
        <div className="bg-white dark:bg-[#0F0C1E] rounded-3xl p-8 md:p-14 shadow-[0_8px_40px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.4)] border border-[#E5E7EB]/60 dark:border-[#23203A]/80">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-serif font-light text-[#1F2937] dark:text-[#F1F0F5] mb-8 flex items-center gap-3">
              <span className="w-8 h-0.5 bg-[#E8177A] rounded-full" />
              Our Story
            </h2>
            <div className="space-y-5 text-[#6B7280] dark:text-[#8B8499] leading-relaxed font-sans">
              <p>
      ...
      {/* Values */}
      <div className="py-16 bg-white dark:bg-[#0F0C1E] border-y border-[#E5E7EB] dark:border-[#23203A]">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center mb-12">
            <p className="text-[#E8177A] font-sans text-[11px] tracking-[0.4em] uppercase mb-3 font-medium">Our Promise</p>
            <h2 className="text-3xl md:text-4xl font-serif font-light text-[#1F2937] dark:text-[#F1F0F5] mb-3">Our Commitment</h2>
            <p className="text-[#6B7280] dark:text-[#8B8499] max-w-lg mx-auto font-sans">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center p-7 bg-[#FFF8FC] dark:bg-[#16112A] rounded-2xl border border-[#E5E7EB]/80 dark:border-[#23203A]/80 hover:shadow-[0_4px_20px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_4px_20px_rgba(0,0,0,0.4)] transition-shadow duration-300 group">
                <div
                ...
                <h3 className="text-lg font-serif font-light text-[#1F2937] dark:text-[#F1F0F5] mb-2">{value.title}</h3>
                <p className="text-[#6B7280] dark:text-[#8B8499] text-sm leading-relaxed font-sans">{value.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="py-16 bg-gradient-to-r from-[#E8177A] to-[#7C3AED]">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          ...
          <ul className="flex flex-wrap justify-center gap-x-8 gap-y-3">
            {["Premium Quality Fabrics", "Professionally Cleaned", "All Sizes Available", "Authentic Designs", "Friendly Service"].map((r) => (
      ...
      {/* CTA */}
      <div className="py-16 bg-white dark:bg-[#0F0C1E] text-center border-t border-[#E5E7EB] dark:border-[#23203A]">
        <div className="container mx-auto px-4 max-w-7xl">
          <h2 className="text-3xl font-serif font-light text-[#1F2937] dark:text-[#F1F0F5] mb-3">Ready to find the right outfit?</h2>
          <p className="text-[#6B7280] dark:text-[#8B8499] font-sans mb-8">Browse hundreds of premium costumes available for rent.</p>
          <Link href="/catalogue">
