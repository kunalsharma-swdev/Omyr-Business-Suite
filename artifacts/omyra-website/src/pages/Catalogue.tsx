    ...
    <div className="min-h-screen bg-[#FFF8FC] dark:bg-[#09061A]">
      ...
      <div className="relative pt-28 pb-16 overflow-hidden bg-gradient-to-br from-white via-[#FFF8FC] to-[#FDF4FF] dark:from-[#09061A] dark:via-[#0F0C1E] dark:to-[#0D0920]">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-serif font-light text-[#1F2937] dark:text-[#F1F0F5] mb-5 leading-tight">
          ...
          <p className="text-[#6B7280] dark:text-[#8B8499] font-sans text-base max-w-lg mx-auto leading-relaxed">
        ...
        {isLoading ? (
          ...
          <>
            <div className="flex items-center justify-between mb-8">
              <p className="text-[#6B7280] dark:text-[#8B8499] font-sans text-sm">
                <span className="font-semibold text-[#1F2937] dark:text-[#F1F0F5]">{categories.length}</span> categories available
              </p>
              <p className="text-[#6B7280] dark:text-[#8B8499] font-sans text-xs tracking-wider uppercase">All products for rent</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {categories.map((category, i) => (
                ...
                >
                  <CategoryCard name={category.name} imageName={category.image_name} />
                </div>
              ))}
            </div>
          </>
        ) : (
          <div className="text-center p-16 bg-white dark:bg-[#0F0C1E] rounded-2xl border border-[#E5E7EB] dark:border-[#23203A]">
            <h2 className="text-xl font-serif font-light text-[#6B7280] dark:text-[#8B8499]">No categories found.</h2>
          </div>
        )}
      </div>
    </div>
