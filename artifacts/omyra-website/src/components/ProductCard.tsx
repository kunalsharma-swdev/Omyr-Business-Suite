  ...
  return (
    <Link href={`/product/${encodeURIComponent(productName)}`}>
      <Card
        ...
        className="group cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-lg h-full flex flex-col border-border"
      >
        ...
        <CardContent className="p-5 flex-grow flex flex-col">
          <h3 className="font-serif text-xl font-bold text-foreground mb-2 line-clamp-2">{productName}</h3>
